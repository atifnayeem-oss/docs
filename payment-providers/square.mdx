...
<Steps>
  ...
  <Step title="They're live immediately">
    The merchant can take payments the moment they connect, with nothing else for you to do. Ringup fires `merchant.connected` (carrying `merchant_id`) so you can reflect it in your own UI.
  </Step>
</Steps>

<Frame caption="Square's own authorization screen: the merchant approves and returns connected.">
  <img src="/images/merchant/square-01-oauth.png" alt="Square OAuth authorization screen" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Clover" href="/payment-providers/clover">The token-paste path for Clover merchants.</Card>
