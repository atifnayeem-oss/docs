...
- **Native handoff.** Payment happens inside your agent, in its own voice, with no transfer.
  The most seamless option where the platform supports it. See your platform's integration guide.
- **Call transfer.** Your agent transfers the call to a Ringup payment line, like redirecting to
  ...
  [Call transfer](/concepts/checkout-session).
...
<CardGroup cols={2}>
  <Card title="Pick your platform" icon="wrench" href="/integrations/vapi/native">
