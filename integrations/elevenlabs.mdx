...
<Steps>
  ...
  <Step title="Assign an agent to each merchant">
    ...
    and the transfer tool. Paste the one prompt line the dashboard shows into the agent's
    prompt, and that merchant's setup is done. Your next merchant is another pick from the
    same list.
  </Step>
