...
Two paths, depending on whether you want to hear it first or start building.

<CardGroup cols={2}>
  <Card title="See it work" icon="play" href="/quickstart">
    **About a minute.** Recognize a caller and create a Checkout Session on the live
    sandbox, with no signup, then hear a fully wired demo call.
  </Card>
  <Card title="Add it to your agent" icon="wrench" href="/concepts/how-it-works">
    **About thirty minutes.** The architecture, the two ways to integrate, and the guide
    for your platform. The same payment path everywhere.
  </Card>
</CardGroup>
