...
<ResponseField name="checkout.completed" type="event">
  A charge against a Checkout Session succeeded. The money moved.
</ResponseField>
<ResponseField name="checkout.failed" type="event">
...
<ResponseField name="merchant.connected" type="event">
...
<ResponseField name="status" type="ChargeStatus">
...
<ResponseField name="reference_id" type="string | null">
  YOUR id for this merchant, echoed back (R15d).
</ResponseField>
